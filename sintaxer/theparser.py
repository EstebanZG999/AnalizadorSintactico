...
class Parser:
    ACTION = {(0, 'NUMBER'): ('shift', 2), (1, 'SEMICOLON'): ('shift', 4), (2, 'PLUS'): ('shift', 5), (5, 'NUMBER'): ('shift', 6), (3, '$'): ('accept', None), (4, '$'): ('reduce', 1), (6, 'SEMICOLON'): ('reduce', 2)}
    GOTO = {(0, 'p'): 1, (0, 's'): 3}
    PRODUCTIONS = [("s'", ['s']), ('s', ['p', 'SEMICOLON']), ('p', ['NUMBER', 'PLUS', 'NUMBER'])]
    START = 's'
